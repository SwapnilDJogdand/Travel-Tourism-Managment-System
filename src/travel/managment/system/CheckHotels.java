...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
        public void run(){
        String[] text = new String[]{"JW Marriott Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radission Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Happy Morning Hotel","Moss View Hotel"};
        try{
        for(int i = 0; i<=9; i++){
    ...
    CheckHotels(){
        ...
        for(int i = 0;i<9;i++){
           image[i] = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/hotel"+(i+1)+".jpg"));
